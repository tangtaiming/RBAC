        ...
        <div class="layadmin-tabsbody-item layui-show">
            ...
            <div class="layui-row">
                <div class="layui-col-md8">
                    <form id="role-form" class="layui-form" action="">
                        <div class="layui-form-item">
                            <label class="layui-form-label">角色名称:</label>
                            <div class="layui-input-block">
                                <div class="layui-col-md7">
                                    <input type="text" name="role.name" required  lay-verify="required" placeholder="请输入角色名称" autocomplete="off" class="layui-input">
                                </div>
                        ...
                        <div class="layui-form-item">
                            <div class="layui-input-block">
                                <input type="button" id="save-role" class="layui-btn" value="立即提交"/>
